...
> **WARNING**
> `:cp` will not rerun all the previous commands → this is clearly a bug
>
> *Consequences*: all variables and setup have to be run again (usual ones are `updateRepo` and the spark conf ones like `jars`, `execUri`, ..)
