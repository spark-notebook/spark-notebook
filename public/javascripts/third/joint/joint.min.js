...
joint.dia.ElementView = joint.dia.CellView.extend({
    ...
    renderMarkup: function() {
        ...
        if (markup) {
            ...
            if (!this.vel) this.vel = V(this.el);
    ...
    pointerdown: function(evt, x, y) {
        ...
        if (evt.target.getAttribute('magnet') && paper.options.validateMagnet.call(paper, this, evt.target)) {
            ...
            /* change to also include the ref to link instance
               for spark-notebook flow.coffee to catch new links*/
            this.model.trigger('batch:start', { batchName: 'add-link', link: link });
